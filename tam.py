...
save = os.path.join(os.path.expanduser("~"), 'tamagochi.txt')
...
def main():
    ...
    with open(save, 'r') as file:
        ...
        for row in reader:
            ...
            pet = {'hunger':int(row[0]), 'energy':int(row[1]), 'waste':int(row[2]), 'age':int(row[3]), 'happiness':int(row[4])}
            covid =int(row[5])
    print(covid)
    # Counters
    off = 0
    ...
    while True:
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_ESCAPE:
                    with open (save,'w') as file:
                        ...
                        print(pet['age'])
                        # x = [pet['age'], pet['hunger'], pet['energy'], pet['waste'], pet['happiness']
                        writer.writerow([pet['hunger'], pet['energy'], pet['waste'], pet['age'], pet['happiness'],covid])
                    pygame.quit()
                    sys.exit()
                    ...
                    # if num == 12:
                    #     text2 = "Shopping went fine"
                    #     pet['happiness'] += 18
                    # elif num == 1:
                    #     text2 = "You caught COVID"
                    #     pet['happiness'] = -10
                    #     covid = 1
                    # elif num == 2:
                    #     text2 = "You bought an RG300"
                    #     pet['happiness'] += 8
                    # elif num == 3:
                    #     text2 = "Got toilet paper"
                    #     pet['happiness'] += 2
                    # elif num == 4:
                    #     text2 = "Met Kim K in store"
                    #     pet['happiness'] -= 2
                    # elif num == 5:
                    #     text2 = "Helped an elderly lady"
                    #     pet['happiness'] += 2
                    # elif num == 6:
                    #     text2 = "Bought a tiger for $2000"
                    #     pet['happiness'] += 28
                    # elif num == 7:
                    #     text2 = "Snee"
                    #     pet['happiness'] += 28
                    # elif num == 8:
                    #     text2 = "Ran out of alcohol wipes"
                    #     pet['happiness'] -= 8
                    break
                    ...
                    has_overlay = False
                    text ="Play a game"
                    text2 ="Left or right trigger"
                    break
                elif key ==1 and ((event.key == pygame.K_TAB and random.randint(1, 20) % 2 == 0) \
                    or (event.key == pygame.K_BACKSPACE and random.randint(1, 20) % 2 != 0)):
                    key =0
                    has_overlay = False
                    pet['happiness'] += 4
                ...
                # surf = font.render(text, True, PIXEL_COLOR)
        ...
        surf3 = font.render(text, True, PIXEL_COLOR)
        screen.blit(surf3, (360, 240))
        surf4 = font.render(text2, True, PIXEL_COLOR)
        screen.blit(surf4, (360, 280))
        score =  pet['age']+pet['happiness']
        surf5 = font.render("SCORE:"+str(score), True, PIXEL_COLOR)
        screen.blit(surf5, (360, 400))
        # Render debug
        #
        ...
        #     surf = font.render(debug[0][pos] % pet[debug[0][pos]], True, PIXEL_COLOR)
